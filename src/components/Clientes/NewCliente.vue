        ...
        <div class="card-body">
          <form @submit.prevent="saveCliente">
            ...
            <div class="row mb-3">
              ...
              <div class="input-group">
                <div class="input-group-text"> <font-awesome-icon icon="user" /></div>
                <input type="text" class="form-control" id="apellido" v-model="cliente.apellido">
              </div>
            </div>
            <div class="row mb-3">
              ...
              <div class="input-group">
                ...
                <input type="text" class="form-control" id="empresa" v-model="cliente.empresa">
              </div>
            </div>
            <div class="row mb-3">
              ...
              <div class="input-group">
                ...
                <input type="text" class="form-control" id="telefono" v-model="cliente.telefono">
              </div>
            </div>
            <div class="row mb-3">
